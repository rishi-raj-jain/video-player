...
export default function Button({ provider }: { provider: { name: string; id: string } }) {
  return (
    <button
      key={provider.name}
      onClick={() => {
      ...
      className="mt-8 hover:bg-[#181818] flex flex-row items-center gap-x-3 bg-transparent text-white border border-[#727272] px-10 py-2.5 rounded cursor-pointer"
    >
